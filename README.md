...
- Pieza especial **anillo** (3×3 lila con hueco central) que aparece ocasionalmente (~1 de cada 16) para subir el reto.
...
| `RING_CHANCE`  | Probabilidad de que salga la pieza anillo | `1/16`                |
